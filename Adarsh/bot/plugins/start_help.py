...
async def start(b, m):
        ...
        try:
            ...
            if user.status == "kicked":
             ...
             await StreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://graph.org/file/d75c64c8e2d92cd4635ef.jpg",
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='https://t.me/devia_angel'>CLICK HERE FOR SUPPORT </a></b>",
    ...
    await StreamBot.send_photo(
        chat_id=m.chat.id,
        photo ="https://graph.org/file/d75c64c8e2d92cd4635ef.jpg",
        caption =f'ʜᴇʟʟᴏ...⚡ {m.from_user.mention(style="md")}!,\n\nI am Telegram File to Link Generator Bot with Channel support.\n\nsᴇɴᴅ ᴍᴇ ᴀɴʏ ᴠɪᴅᴇᴏ / ғɪʟᴇ ᴛᴏ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀᴢ...',
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [ANGEL](https://t.me/devia_angel).",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ DEV", url="https://t.me/devia_angel")],
                [InlineKeyboardButton("💥 Join Us", url="https://t.me/OPleech_Updates")]
            ]
        )
    )
